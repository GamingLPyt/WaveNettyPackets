...
import eu.wavecode.netty.data.server.SimpleNettyServer;
 ...
 */
public class TestSimpleNettyServer {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final SimpleNettyServer simpleNettyServer = SimpleNettyServer.builder()
                .port(8080)
                .ssl(false)
                .packetRegistry(packetRegistry)
                .build();

        simpleNettyServer.createServer();
